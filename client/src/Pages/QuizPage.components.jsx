...
export const QuizPage = ({saveOrder}) => {
    ...
    useEffect(() =>  {
        const fetch = async () => {
            const quizData = await axios.get("/api/quiz-items");
    ...
    return(
        <div className="quiz-page" style={{backgroundColor:showSpinner? "#3f4444" : "#f8edeb"}}>
            ...
            <div className="quiz-container">
                {sectionIndex >= 0 && sectionIndex === quizSections.length ?  <SummerizeSection title="Candle Summary" candleObj = {candleObj} saveOrder={saveOrder}/> :quizSections[sectionIndex]}
            </div>
